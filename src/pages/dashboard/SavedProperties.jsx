// src/pages/dashboard/SavedProperties.jsx
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium px-8 py-4 rounded-xl hover:shadow-lg transition-all duration-300"
            >
                  ...
                  <div className="flex items-center justify-between pt-4 border-t">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="bg-gradient-to-r from-amber-600 to-orange-500 text-white text-sm font-medium px-4 py-2 rounded-lg hover:shadow transition-all duration-200"
                      >
                        Apply Now
                      </button>
                    </div>
